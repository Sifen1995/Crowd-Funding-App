          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                ...
                <button className="mt-6 w-full py-3 px-4 rounded-md text-white font-semibold bg-[#6A5A82] hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6A5A82]">
                  Contribute
                </button>
              </div>
